...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        GLES30.glClearColor(0f, 1f, 1.0f, 0.0f);
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        Matrix.setRotateM(mRotationMatrix, 0, mAngle, 0, 0, 0f);
       ...
       // mCube.draw(mMVPMatrix);
            if(shouldDrawCube)
            {
                Matrix.setRotateM(mRotateCubeM, 0, mCubeRotation, -1.0f, -1.0f, -1f);
                ...
                Matrix.setRotateM(mRotateCubeM, 0, mCubeRotation, -1.0f, -1.0f, -1.0f);
